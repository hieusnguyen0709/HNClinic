...
<div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Đăng ký lịch làm</h4>
                  <form method="post" role="form" action="{{URL::to('/bac-si/kt-dang-ky-lich-lam')}}" enctype="multipart/form-data" class="form-sample">
                  {{ csrf_field() }}
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <select class="form-control" name="type">
                              <option value="{{$doctor_id}}"> {{App\Models\User::where('id',$doctor_id)->value('last_name')}}</option>
                            </select>
                          </div>
                        </div>
                      </div>
