                ...
                <div class="card-body">
                  ...
                  <hr>
                    @if($pres->require_testing == 0)
                      <center>
                        <a href="{{URL::to('/bac-si/danh-sach-lich-da-kham/')}}" class="btn btn-primary">Quay lại</a>
                      </center><br>
                      <center>
                        <a href="{{URL::to('/bac-si/yeu-cau-xet-nghiem-don-thuoc/'.$pres->schedule_id)}}" class="btn btn-dark">Yêu cầu xét nghiệm</a>
                      </center>
                    @endif
