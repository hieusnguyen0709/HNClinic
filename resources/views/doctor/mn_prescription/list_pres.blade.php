                    ...
                    <table class="table table-striped">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                          {{App\Models\User::where('id',$pres->patient_id)->value('last_name')}}
                          </td>
                          <td>
                          {{$pres->symptoms}}
                          </td>
                          ...
                          <td>
                            <a href="{{URL::to('/bac-si/sua-don-thuoc/'.$pres->id_pres)}}">Sửa</a> |
                            <a href="{{URL::to('/bac-si/xoa-don-thuoc/'.$pres->id_pres)}}">Xóa</a>
                          </td>
                        </tr>
                        @endforeach
                      </tbody>
