              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <?php
                    ...
                    <form action="{{URL::to('bac-si/ket-qua-xet-nghiem')}}" style="display:inline; float:right">
                    ...
                    <div id="show_filter">
                         @include('doctor.mn_test.filter_list_test_result')
                    </div>
                </div>
              </div>
            </div>
<script>
          function filterFunction()
          {
            ...
            $.ajax({
              url:"{{URL::to('/bac-si/ket-qua-xet-nghiem')}}",
              type:"GET",
              data:{option:value},
