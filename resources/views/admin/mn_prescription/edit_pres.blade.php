                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row" >
                              ...
                              <div class="col-sm-9">
                                <input type="number" class="form-control timepicker" name="quantity[]" id="quantity" value="{{$m_i->pre_quantity}}"/>
                              </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-sm-9">
                              <input type="number" class="form-control timepicker" name="total_days[]" id="total_days" value="{{$m_i->total_days}}"/>
                              </div>
                            </div>
                        </div>
                      </div>
