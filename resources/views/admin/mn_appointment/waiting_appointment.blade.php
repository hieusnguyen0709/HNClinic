                        ...
                        @foreach($show_list_appointment as $key => $appointment)
                          <tr>
                              ...
                              <td>
                                  ...
                                  <a href="{{URL::to('/admin/nhap-ket-qua-kham/'.$appointment->schedule_id)}}" class="btn btn-primary" style="width:150px;">Nhập kết quả</a>
                              </td>
                              @endif
                              ...
                              <td>
                                <a href="{{URL::to('/admin/yeu-cau-xet-nghiem/'.$appointment->schedule_id)}}" class="btn btn-dark" style="width:100px;">Yêu cầu</a>
                              </td>
                              @endif
