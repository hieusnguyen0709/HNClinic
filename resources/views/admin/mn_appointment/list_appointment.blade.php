...
<div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <?php
                    ...
                    <form action="{{URL::to('admin/danh-sach-lich-hen')}}" style="display:inline; float:right">
                  ...
                  <div id="show_filter">
                      @include('admin.mn_appointment.filter.filter_list_appointment')
                  </div>
                </div>
              </div>
            </div>
    ...
    <script>
      function filterFunction()
      {
        ...
        $.ajax({
          url:"{{URL::to('/admin/danh-sach-lich-hen')}}",
          type:"GET",
          data:{option:value},
