...
<div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  ...
                  <form method="post" role="form" action="{{URL::to('/admin/kt-sua-lich-hen/'.$appointment->schedule_id)}}" enctype="multipart/form-data" class="form-sample">
                  {{ csrf_field() }}
                  ...
                  <script>
                    	function scheduleFunction()
                      {
                        ...
                        $.ajax({
                          url:"{{URL::to('/admin/sua-lich-hen/'.$appointment->schedule_id)}}",
                          type:"GET",
                          data:{option:value},
