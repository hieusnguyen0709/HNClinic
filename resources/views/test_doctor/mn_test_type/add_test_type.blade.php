...
<div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  ...
                  <form method="post" role="form" action="{{URL::to('/bac-si-xet-nghiem/kt-them-loai-xet-nghiem')}}" enctype="multipart/form-data" class="form-sample">
                  {{ csrf_field() }}
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control timepicker" name="name_type" required/>
                          </div>
                        </div>
                      </div>
                    </div>
