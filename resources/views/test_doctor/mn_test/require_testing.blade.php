              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <?php
                    ...
                    <form action="{{URL::to('bac-si-xet-nghiem/yeu-cau-xet-nghiem')}}" style="display:inline; float:right">
                    ...
                    <div id="show_filter">
                         @include('test_doctor.mn_test.filter_require_testing')
                    </div>
...
<script>
  function filterFunction()
  {
    ...
    $.ajax({
      url:"{{URL::to('/bac-si-xet-nghiem/yeu-cau-xet-nghiem')}}",
      type:"GET",
      data:{option:value},
